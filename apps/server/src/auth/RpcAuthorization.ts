...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.childAgentList]: AuthOrchestrationReadScope,
  [WS_METHODS.childAgentTranscript]: AuthOrchestrationReadScope,
  [WS_METHODS.childAgentCancel]: AuthOrchestrationOperateScope,
  [WS_METHODS.childAgentSubscribeChanges]: AuthOrchestrationReadScope,
